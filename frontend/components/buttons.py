...
class AnimatedStateButton(QPushButton):
    def __init__(self, *args, **kwargs):
        ...
        self._inactive_color = QColor("#e74c3c")  # Red
    ...
    def paintEvent(self, event):
        ...
        if self._active:
            ...
            gradient.setColorAt(0.0, self._active_gradient_colors[0])  # Green at start
            gradient.setColorAt(0.5, self._active_gradient_colors[1])  # White at middle
            gradient.setColorAt(1.0, self._active_gradient_colors[0])  # Green at end
